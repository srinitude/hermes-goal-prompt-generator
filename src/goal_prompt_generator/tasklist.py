...
def build_task_list(goal_path: Path, task_path: Path, source_hash: str, title: str) -> dict[str, Any]:
    ...
    data = {
        ...
        "validation_evidence": {
            "firecrawl": {"cli_version": "unavailable", "auth": "unavailable", "url_maps_root": "research/url-maps", "required_maps_present": {}, "evidence": ["Validate official docs with Firecrawl at execution time."]},
            "opensrc": {"cli_version": "unavailable", "cache_root": "", "fetched": {}, "divergences": []},
